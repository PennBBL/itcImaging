...
for s in $serieslist; do
	...
	/import/monstrum/fndm2_new/progs/coregistration/epi_reg_tds_v3.sh --epi==$prestatsdir/example_func_brain --t1=$t1head --t1brain=$t1brain --t1wm=$wmseg --wd=$outdir -v --out=$outdir/ep2struct
