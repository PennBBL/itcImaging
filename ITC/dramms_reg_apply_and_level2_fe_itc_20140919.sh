...
outdir=level2_fe_20130904/  #will need to be changed
...
#get number of copes from cardA
...
for i in $imglist; do
	...
	if [ ! -e "$outdir/$img/varcope4.nii.gz" ]; then #varcope 4 because only 4 contrasts in the second level design
		...
		#anup you will want to ahve the .mat, .con, .grp files from your example 2nd level analysis that you ran.
