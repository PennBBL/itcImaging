...
logdir=/import/monstrum/day2_fndm/progs/T1/logs/
...
outname=n3_maskstr_micobc_mni2mm_ravens_250.nii.gz #name of last file created so can check if completed already
####
